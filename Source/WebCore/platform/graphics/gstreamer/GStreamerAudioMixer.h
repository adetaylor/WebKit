...
#ifndef WebCore_platform_graphics_gstreamer_GStreamerAudioMixer_h
#define WebCore_platform_graphics_gstreamer_GStreamerAudioMixer_h
...
#endif // USE(GSTREAMER)
#endif // WebCore_platform_graphics_gstreamer_GStreamerAudioMixer_h
