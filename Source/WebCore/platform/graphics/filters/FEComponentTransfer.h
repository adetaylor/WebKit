...
#ifndef WebCore_platform_graphics_filters_FEComponentTransfer_h
#define WebCore_platform_graphics_filters_FEComponentTransfer_h
...
#endif // WebCore_platform_graphics_filters_FEComponentTransfer_h
