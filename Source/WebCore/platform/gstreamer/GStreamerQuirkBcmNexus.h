...
#ifndef WebCore_platform_gstreamer_GStreamerQuirkBcmNexus_h
#define WebCore_platform_gstreamer_GStreamerQuirkBcmNexus_h
...
#endif // USE(GSTREAMER)
#endif // WebCore_platform_gstreamer_GStreamerQuirkBcmNexus_h
