...
#ifndef WebCore_platform_gstreamer_GStreamerQuirkAmLogic_h
#define WebCore_platform_gstreamer_GStreamerQuirkAmLogic_h
...
#endif // USE(GSTREAMER)
#endif // WebCore_platform_gstreamer_GStreamerQuirkAmLogic_h
