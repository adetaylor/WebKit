...
#ifndef WebCore_platform_gstreamer_GStreamerQuirkWesteros_h
#define WebCore_platform_gstreamer_GStreamerQuirkWesteros_h
...
#endif // USE(GSTREAMER)
#endif // WebCore_platform_gstreamer_GStreamerQuirkWesteros_h
