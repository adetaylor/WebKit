...
#ifndef WebCore_platform_gstreamer_GStreamerQuirks_h
#define WebCore_platform_gstreamer_GStreamerQuirks_h
...
#endif // USE(GSTREAMER)
#endif // WebCore_platform_gstreamer_GStreamerQuirks_h
