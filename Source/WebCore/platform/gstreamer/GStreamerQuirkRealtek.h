...
#ifndef WebCore_platform_gstreamer_GStreamerQuirkRealtek_h
#define WebCore_platform_gstreamer_GStreamerQuirkRealtek_h
...
#endif // USE(GSTREAMER)
#endif // WebCore_platform_gstreamer_GStreamerQuirkRealtek_h
