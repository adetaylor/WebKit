...
#ifndef WebCore_accessibility_atspi_AccessibilityObjectAtspi_h
#define WebCore_accessibility_atspi_AccessibilityObjectAtspi_h
...
#endif // USE(ATSPI)
#endif // WebCore_accessibility_atspi_AccessibilityObjectAtspi_h
